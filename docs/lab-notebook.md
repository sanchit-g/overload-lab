...
![knee latency](img/knee-latency.png)
...
![2x latency](img/s0-fragile-A-rate74-r4-latency.png)
![2x queue and heap](img/s0-fragile-A-rate74-r4-queue-heap.png)
![2x pools](img/s0-fragile-A-rate74-r4-pools.png)
